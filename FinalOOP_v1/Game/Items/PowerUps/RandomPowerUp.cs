...
namespace Game
{
    public class RandomPowerUp : PowerUp
    {
        ...
        void SpeedPowerUpAN()
        {
            PowerUpsFactory.CreatePowerUp(PowerUpsFactory.PowerUps.speed);
        }

        void HealthPowerUpAN()
        {
            PowerUpsFactory.CreatePowerUp(PowerUpsFactory.PowerUps.life);
        }

        void DamagePowerUpAN()
        {
            PowerUpsFactory.CreatePowerUp(PowerUpsFactory.PowerUps.damage);
        }
