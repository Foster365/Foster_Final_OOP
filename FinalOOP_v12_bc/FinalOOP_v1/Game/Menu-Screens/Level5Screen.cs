...
namespace Game
{
    public class Level5Screen : Screen
    {
        ...
        public override void ResetLevel()
        {
            ...
            if (Program.ActualScreenState == Program.ScreenFlow.level5Screen)
            {
        ...
        void EnemySpawn()
        {
            ...
            if (enemySpawnerTimer >= timetoCreate)
            {
                ...
                Program.Characters.Add(EnemyFactory.CreateEnemy(EnemyFactory.EnemiesFactory.finalBossEnemy, enemyPosition));
                enemySpawnerTimer = 0;
        ...
        void CreateAsteroid()
        {
            ...
            if (asteroidTimer >= asteroidSpawnTime)
            {
                ...
                Program.Environment.Add(AsteroidsFactory.CreateAsteroid(AsteroidsFactory.AsteroidFactory.asteroid5, asteroidPosition));
                asteroidTimer = 0;
        ...
        void Environment_Textures()
        {
            ...
            Program.Environment.Add(new Image(new Vector2(0, 150), new Vector2(1.5f, 1.5f), new Vector2(1280, 640), 0, "Textures/Level_Backgrounds/Level_5.jpg"));
